...
START_TEST(infixToReversePolish_withUnmatchedOpenParen_returnsError)
{
    char actual[MAX_EXPRESSION_LENGTH];
    ck_assert_int_eq(RPN_PARSE_ERROR_UNMATCHED_OPEN_PAREN, infixToReversePolish("a+(", actual, MAX_EXPRESSION_LENGTH));
}
END_TEST
